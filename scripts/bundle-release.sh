...
echo "Create App Bundle for ${FLAVOR}${BUILD_TYPE}"
...
${REPO_DIR}/gradlew -p "$REPO_DIR" clean bundle${FLAVOR}${BUILD_TYPE} -Dpre-dex=false

open "$REPO_DIR/app/build/outputs/bundle/${FLAVOR}${BUILD_TYPE}/"
